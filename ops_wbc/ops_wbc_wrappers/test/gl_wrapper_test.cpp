/*************************************************************************
	> File Name: gl_wrapper_test.cpp
	> Author: Yi Zheng 
	> Mail: hczhengcq@gmail.com
	> Created Time: Mon 29 Jan 2018 03:45:38 PM PST
 ************************************************************************/
...
void display()
{
    try
    {
        ...
        std::string path = "/home/bml/yzheng_ws/src/ops_wbc/ops_wbc_wrappers/";
...
{
    ros::init(argc, argv, "ops_wbc_wrappers");
    ros::NodeHandle nh;
