    ...
    class FunctionApproximator : public Parameterizable
    {
        public:
            ...
            */
            ...
            // ------Functions from Parameterizable class--------
            void getSelectableParameters(std::set<std::string>& selected_values_labels) const;
            void setSelectedParameters(const std::set<std::string>& selected_parameters_labels);
            ...
            UnfiedModel* getUnifiedModel(void) const;
...
BOOST_SERIALIZATION_ASSUME_ABSTRACT(function_approximator::FunctionApproximator);
 
/** Don't add version information to archives. */
#include <boost/serialization/export.hpp>
BOOST_CLASS_IMPLEMENTATION(function_approximator::FunctionApproximator,boost::serialization::object_serializable);
