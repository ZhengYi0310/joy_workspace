...
int main(int argc, char** argv)
{
  ...
  */
  ...
  ros::Time start_time = biotac_state_recorder.getStartRecordingResponse().start_time + ros::Duration(1.0);
  ...
  const int num_samples = std::floor((end_time - start_time).toSec()) * 100;
